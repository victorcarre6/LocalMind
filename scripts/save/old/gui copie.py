...
def on_generate():
    ...
    try:
        ...
        final_prompt = on_ask(user_input, context_limit=context_count, keyword_count=keyword_count, recall=memory_recall)
...
# Removed btn_settings from button_frame to avoid duplication
# btn_settings = ttk.Button(button_frame, text="Settings", command=open_settings, style='Bottom.TButton', width=8)
